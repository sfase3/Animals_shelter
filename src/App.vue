...
.about_shelter_content_info{
      padding-left: 70px;
}

.about_shelter_content_info h2{
      max-width: 350px;
      font-family: Georgia;
font-size: 35px;
line-height: 45px;
